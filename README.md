...
This "hello world" example is 1.20 MB in compressed HTTP transfer size (6.14 MB uncompressed). On a modest ~2020 notebook, the server startup time is 950 MS and page load is 400 MS.
