...
This "hello world" example is 1.20 MB in compressed HTTP transfer size (6.14 MB uncompressed). On a modest ~2020 notebook, the server startup time is 950 MS, page load time is 400 MS, Java heap size after GC is 20 MB, total process memory size is 350 MB.
